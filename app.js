...
navbarList.addEventListener("click", (e) => {
    if (
      e.target.classList.contains("nav__list--btn") ||
      ...
      if (confirm("Are you sure you want to delete all products?")) {
        ...
        e.currentTarget.firstElementChild.innerText = "Product";
        calculateCartPrice();
      }
    }
  });
...
const calculateCartPrice = () =>{
    ...
    const taxPrice = parseFloat(subtotal * localStorage.getItem("taxtRate")); 
